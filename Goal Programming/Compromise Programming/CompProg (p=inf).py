# -*- coding: utf-8 -*-
"""
Created on Fri Jan  7 14:32:51 2022
...
#y = min( (5*M.x[1] + 4*M.x[2] - z1)/z1, (10*M.x[3] + 20*M.x[4] - z2)/z2 ) 


M.Z = Objective(expr = M.y , sense = maximize)

M.ST = ConstraintList()

M.ST.add(M.y <= (5*M.x[1] + 4*M.x[2] - z1)/z1)
M.ST.add(M.y <= (10*M.x[3] + 20*M.x[4] - z2)/z2)
