...
M.ST.add(M.y[1] + 10*M.x[1] + 30*M.x[2] + 50*M.x[3] + 100*M.x[4] >= 3000)
M.ST.add(M.x[1] + 4*M.x[2] + 6*M.x[3] + 2*M.x[4] >= 219.534)
M.ST.add(M.x[1] + M.x[2] >= 46.5)
M.ST.add(10*M.x[1] + 30*M.x[2] + 50*M.x[3] + 100*M.x[4] >= 1936.44)
